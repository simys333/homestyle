...
/*.sf-gallery__stage .sf-image {
  ...
  .sf-price__regular
   ...
   .products .sf-product-card__image-wrapper
   {
...
.category-layout .navbar
{
  border-bottom: 1px solid var(--c-light);
  border-top: 0px;
  border-width: 0px 0 1px 0 !important;
}
.category-layout .heading__title {
    border: 0px solid var(--c-light);
...
.product__info .sf-add-to-cart__button
{
  width:40% !important;
  flex: 1 1 33%;
}
.product .sf-add-to-cart__select-quantity
{
  flex: 1 1 100%;
}
.product .product_checkout
{
  flex: 1 1 33%;
}
.product .product__additional-actions
{
  flex: 1 1 2%;
}
.product .sf-add-to-cart
{
  display: flex;
  flex-wrap: wrap;
...
.product .sf-quantity-selector__button
{
  border-width:1px;
  border-color: #756A67;
  border-style: solid;
...
.product .product_bulk a{
  text-decoration:underline;
}
.product .borderbtn.sf-button {
    color: #f8470a;
